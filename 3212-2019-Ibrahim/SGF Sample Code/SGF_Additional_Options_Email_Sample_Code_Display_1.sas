...
/* Define macro to send employee compensation reports with additional options */
%macro sendreports(department,email,name,mgremail,deptmgremail);
...
data _null_;
  ...
  call execute(cats('%sendreports(',department,',',email,',',name,',',mgremail,',',deptmgremail,')'));
  end;
 run; 
